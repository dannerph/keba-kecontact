...
class Emulator:
    ...
    async def _internal_callback(self, raw_data, remote_addr):
        ...
        _LOGGER.info(f"Datagram recvied from {remote_addr}: {data}")
        ...
        try:
            if data == "i":
                ...
                i = int(split[1])
                if i == 1:
                    payload = '{"ID": "1","Product": "KC-P30_Emulator","Serial": "123456789","Firmware":"Emulator v 2.0.0","COM-module": 0,"Sec": 0}'
                elif i == 2:
                    ...
                    payload = '{"ID": "3","U1": 230,"U2": 230,"U3": 230,"I1": 99999,"I2": 99999,"I3": 99999,"P": 99999999,"PF": 1000,"E pres": 999999,"E total": 9999999999,"Serial": "123456789","Sec": 4294967296}'

                elif i >= 100:
                    payload = (
                        '{"ID": "'
                        + str(i)
                        + '","Session ID": 35,"Curr HW ": 20000,"E Start ": 29532,"E Pres ": 0,"started[s]": 1698,"ended[s] ": 0,"reason ": 0,"RFID tag": "e3f76b8d00000000","RFID class": "01010400000000000000","Serial": "123456789","Sec": 1704}'
                    )
